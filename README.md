...
- Drill into any worker to see their current project assignments, marked availability, and completed tasks — including the clock-out photo, viewable full-size, with a **Confirm** action to sign off on completed work
